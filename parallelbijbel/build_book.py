...
BOOK_TITLES = {
    ...
    "MRK": "Het Evangelie naar Marcus",
    "MAT": "Het Evangelie naar Matteüs",
    "JHN": "Het Evangelie naar Johannes",
    "ACT": "De Handelingen van de Apostelen",
    "PHM": "De brief van Paulus aan Filemon",
    "ROM": "De brief van Paulus aan de Romeinen",
    "1CO": "De eerste brief van Paulus aan de Korintiërs",
    "2CO": "De tweede brief van Paulus aan de Korintiërs",
    "GAL": "De brief van Paulus aan de Galaten",
    "EPH": "De brief van Paulus aan de Efeziërs",
    "PHP": "De brief van Paulus aan de Filippenzen",
    "COL": "De brief van Paulus aan de Kolossenzen",
    "1TH": "De eerste brief van Paulus aan de Tessalonicenzen",
    "2TH": "De tweede brief van Paulus aan de Tessalonicenzen",
    "1PE": "De eerste brief van Petrus",
    "2PE": "De tweede brief van Petrus",
    "1TI": "De eerste brief van Paulus aan Timoteüs",
    "2TI": "De tweede brief van Paulus aan Timoteüs",
    "TIT": "De brief van Paulus aan Titus",
    "HEB": "De brief aan de Hebreeën",
    "JAS": "De brief van Jakobus",
