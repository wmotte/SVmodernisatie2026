...
## Ronde 1 — REV + JHN  (2026-06-05T16:05:52.763646+00:00)
Red bracht 7 punt(en). Verdicts: red_wins=7, green_wins=0, rule_change=0.
- **[RG1-001] (consistentie)** Vrouw, waarom huilt u?
  - regel: Projectregel κλαίω→wenen; AGENTS.md concordantie; fix: v13: 'Vrouw, waarom weent u?'  v15: 'Vrouw, waarom weent u? Wie zoekt u?'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. κλαίω→wenen is een reeds-bestaande durende projectregel; v11 ankert 'wenen' in dezelfde scene, SV-bron 'wat weent ghy'. Bestaande regel geschonden — alleen vers fixen.
- **[RG1-002] (consistentie)** Vrouw, waarom huilt u? Wie zoekt u?
  - regel: Projectregel κλαίω→wenen; AGENTS.md concordantie; fix: 'Vrouw, waarom weent u? Wie zoekt u?'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. Identiek aan RG1-001: κλαίεις, SV 'weent ghy', v11-anker. Bestaande κλαίω→wenen-regel; verse-fix.
- **[RG1-003] (modernisatie)** dat u zult huilen en weeklagen
  - regel: Projectregel κλαίω→wenen; fix: 'dat u zult wenen en weeklagen'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. κλαύσετε (fut. κλαίω); vast doelwoord 'wenen' reeds projectregel, consistent met JHN 20:11 / REV 5:4. Verse-fix 'huilen'→'wenen'.
- **[RG1-004] (modernisatie)** Komt hierheen op.
  - regel: MODERNISATIE.md (imperatief-`-t`); ARCHAISMEN.md:78; fix: 'Kom hierheen omhoog.' / 'Kom hier omhoog.'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. Ἀνάβητε 2e mv. imperatief; imperatief-`-t`→stam staat reeds in ARCHAISMEN.md:78. 'Komt'→'Kom'. Bestaande regel; verse-fix.
- **[RG1-005] (consistentie)** Komt en ziet.
  - regel: MODERNISATIE.md (imperatief-`-t`); ARCHAISMEN.md:78; fix: 'Kom en zie.'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. Ἔρχεσθε καὶ ἴδετε 2e mv. imperatieven → stam 'Kom en zie'; ARCHAISMEN.md:78 dekt dit al, REV 6:1,3 al correct. Bestaande regel; verse-fix.
- **[RG1-006] (modernisatie)** Opdat u eet het vlees van de Koningen
  - regel: MODERNISATIE.md §2.3b (patroon 1: object nageschoven; werkwoord niet finaal in bijzin); fix: 'Opdat u het vlees van de koningen eet, en het vlees van de oversten ...' (of 'zodat u ... eet').
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. Rode §-label (§2.3b) was mislabeled maar onderliggende §2.3-zinsbouw (werkwoord-finaal in opdat-bijzin) is bestaande regel. Soft verse-fix, geen nieuwe regel.
- **[RG1-007] (modernisatie)** zeven vurige lampen waren brandende voor de troon
  - regel: MODERNISATIE.md §2.3 (predicatief/periphrastisch participium); fix: 'en zeven vurige lampen brandden voor de troon'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. καιόμεναι predicatief participium; §2.3 periphrastisch `-ende`→finiet is reeds een regel. 'waren brandende'→'brandden'. Verse-fix.

## Ronde 2 — REV + 1CO  (2026-06-05T17:22:29.476810+00:00)
Red bracht 7 punt(en). Verdicts: red_wins=7, green_wins=0, rule_change=0.
- **[RG2-001] (modernisatie)** zei: Neemt, eet: dat is mijn lichaam, dat voor u gebroken wordt: doet dat tot mijn gedachtenis.
  - regel: ARCHAISMEN.md (imperatief-meervoud op `-t` → stam); MODERNISATIE.md imperatief-`-t`; fix: 'zei: Neem, eet: dat is mijn lichaam, dat voor u gebroken wordt: doe dat tot mijn gedachtenis.'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. Λάβετε/ποιεῖτε zijn 2e pers. mv. imperatieven; SV-`-t` 'Neemt'/'doet' → stam 'Neem'/'doe'. Regel bestaat reeds (ARCHAISMEN.md imperatief-`-t`→stam); φάγετε al correct als 'eet'. Geen
- **[RG2-002] (modernisatie)** Doet dat, zo dikwijls als gij [die] zult drinken, tot mijn gedachtenis.
  - regel: ARCHAISMEN.md (imperatief-meervoud op `-t` → stam; ghy/gy/gij → u); fix: 'Doe dat, zo dikwijls als u [die] zult drinken, tot mijn gedachtenis.'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. ποιεῖτε → 'Doe' (imperatief-`-t`→stam, bestaande regel); 'gij' in hoofdtekst → 'u' (bestaande ghy/gy/gij→u-substitutie). Beide drempel-archaismen vallen onder reeds gecodeerde regels
- **[RG2-003] (modernisatie)** Want zo dikwijls als gij dit brood zult eten, en deze drinkbeker zult drinken
  - regel: ARCHAISMEN.md (ghy/gy/gij → u); fix: 'Want zo dikwijls als u dit brood zult eten, en deze drinkbeker zult drinken'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. Residueel 'gij' (ἐσθίητε/πίνητε) in hoofdtekst → 'u' onder bestaande ghy/gy/gij→u-substitutie. Geen citaat- of kanttekening-uitzondering. Bestaande regel.
- **[RG2-004] (consistentie)** Maar hetgeen u hebt, houdt dat vast totdat ik zal komen.
  - regel: ARCHAISMEN.md (imperatief-meervoud op `-t` → stam); MODERNISATIE.md imperatief-`-t`; fix: 'Maar houd vast wat u hebt, totdat ik kom.'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert de `-t`-fix. κρατήσατε is imperatief mv. → stam 'houd', aspect-onafhankelijk (bestaande imperatief-`-t`→stam-regel). Aspectverschil met 3:11 mag lexicaal divergeren maar redt de `-t` 
- **[RG2-005] (modernisatie)** Indien wij alleen in dit leven op Christus hopende zijn, zo zijn wij de ellendigste van alle mensen.
  - regel: MODERNISATIE.md §2.3 (finiet participium / -ende); fix: 'Indien wij alleen voor dit leven onze hoop op Christus gevestigd hebben, dan zijn wij de ellendigste van alle mensen.'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. ἠλπικότες ἐσμέν perifrastisch perfectum, geen attributief participium; valt onder bestaande §2.3 (finiet participium → persoonsvorm). 'op Christus hopende zijn' = SV-carry-over, ontv
- **[RG2-006] (modernisatie)** die eet en drinkt zichzelf een oordeel, niet onderscheidende het lichaam des Heeren.
  - regel: MODERNISATIE.md §2.3 (finiet participium) + §2.3b (object nageschoven na participium); fix: '... haalt zich een oordeel op de hals, omdat hij het lichaam van de Heere niet onderscheidt.'
  - verdict: **red_wins** (scope=verse, applied=False) — Green concedeert. μὴ διακρίνων bijwoordelijk participium; 'niet onderscheidende het lichaam des Heeren' draagt -ende-participium (§2.3) + nageschoven object (§2.3b). Beide regels bestaan reeds.
...
## Ronde 24 — HEB + TIT  (2026-06-08T06:51:46.935355+00:00)
Red bracht 3 punt(en). Verdicts: red_wins=3, green_wins=0, rule_change=0.
- **[RG24-001] (consistentie)** Verhardt dan
  - regel: ARCHAISMEN.md:80 'imperatief-meervoud op -t → gebruik de stam'; MEMORY 'Imperatief-meervoud -t → stam'; precedent RG22-001/003, RG23-001 (wandelt → wandel); fix: Verhard dan
  - verdict: **red_wins** (scope=verse, applied=True) — Green concedeert. HEB 3:8 'Verhardt dan' laat de SV-imperatief-meervoud op -t onaangeroerd staan, terwijl exact hetzelfde Griekse verbod μὴ σκληρύνητε τὰς καρδίας ὑμῶν uit Ps. 95 in HEB 4:7 binnen het
- **[RG24-002] (modernisatie)** De [Zendbrief] aan Titus, de eerste verkoren Grieks: Episcopon. Dat Titus een Evangelist is geweest, door de Apostelen h
  - regel: KANTTEKENINGEN.md:8 ('<…> blokken bewaren — nooit verwijderen, nooit samenvoegen'); AGENTS.md §1 'Renovatie, geen hervertaling' / leesbaar modern Nederlands; fix: Wikkel beide ingebedde noten in <...> en herstel de hoofdzin, bv.: 'De [Zendbrief] aan Titus, de eerste verkoren <Grieks: Episcopon. Dat Titus een Evangelist is geweest, door de Apostelen hier en daar gezonden om het Evangelie te verbreiden, wordt uit de Schrift wel afgeleid, maar niet dat hij ergens een Bisschop, zoals zij tegenwoordig in het Pausdom genoemd worden, zou geweest zijn.> Opziener van de gemeente der Kretenzen, is geschreven <Zie hiervan vers 12, waaruit ook blijkt dat deze onderschriften niet overal vaststaan, zoals dikwijls is aangetekend.> van Nicopolis in Macedonië. Einde van de Zendbrief van Paulus aan Titus.'
  - verdict: **red_wins** (scope=verse, applied=True) — Green concedeert (geherclassificeerd als scaffolding/bron-delimiter-reparatie: defect echt, maar bron mist <> al; fix input.sv + output). Concede op het leesbaarheidsdefect, maar met geherclassificeer
...
## Ronde 41 — REV + MAT  (2026-06-08T13:09:40.742685+00:00)
Red bracht 4 punt(en). Verdicts: red_wins=4, green_wins=0, rule_change=0.
- **[RG41-001] (modernisatie/false-friend)** de mensen zo geleerd zal hebben
  - regel: ARCHAISMEN.md:147 false friend `leren`/`geleerd` (διδάσκω, transitief-didactisch, leraar-subject) → onderwijzen/onderwezen; NT-brede precedent RG-16-RG16-003 (2JN), RG-30-RG30-009 (2PE), RG-33-RG33-001..006 (ACT/ROM), RG-35-RG35-003/004 (LUK), allen red_wins; fix: 'de mensen zo geleerd zal hebben' → 'de mensen zo onderwezen zal hebben'; en 'zal gedaan en geleerd hebben' → 'zal gedaan en onderwezen hebben' (beide διδάξῃ in dit vers).
  - verdict: **red_wins** (scope=verse, applied=True) — MAT 5:19 διδάξῃ ×2 (διδάσκω actief, leraar-subject, geen μανθάνω): 'geleerd'→'onderwezen' (2×). False friend ARCHAISMEN.md:147.
- **[RG41-002] (consistentie/genitief-allowlist-lek)** vele lichamen der heiligen
  - regel: MODERNISATIE.md §2.3c losse possessief-genitief ontvouwt naar 'van de'; rules_data.py:117 FOSSIL_GENITIVE_PAIRS-entry ('der','heiligen') is bedoeld voor 'Heilige der heiligen' (ἅγια τῶν ἁγίων); precedent R35 der-Joden, R37 der-aarde, R40 der-heiligen (REV 13:10/14:12/17:6/19:8); fix: 'vele lichamen der heiligen' → 'vele lichamen van de heiligen'.
  - verdict: **red_wins** (scope=verse, applied=True) — MAT 27:52 σώματα τῶν ἁγίων bezitsgenitief 'lichamen der heiligen'→'van de heiligen' (content-only, allowlist-lek zoals R40). 'Heilige der heiligen' alleen in 27:51-noot, allowlist blijft.
- **[RG41-003] (modernisatie/false-friend)** leer hen onderhouden alles
  - regel: ARCHAISMEN.md:147 false friend `leren` (διδάσκω, transitief-didactisch, leraar-subject) → onderwijzen; consistentie binnen dezelfde zendingsopdracht (v19 'onderwijs alle volken' = μαθητεύσατε al gefixt); fix: 'leer hen onderhouden alles wat ik u geboden heb' → 'onderwijs hen alles te onderhouden wat ik u geboden heb' (of 'leer hen alles onderhouden' behouden uitsluitend mits het gerundium-idioom prefereert; primaire fix = onderwijs).
  - verdict: **red_wins** (scope=verse, applied=True) — Verse-correctie: staat in MAT 28:19 (niet 28:20). διδάσκοντες leraar-subject 'leer hen'→'onderwijs hen', concordant met v19 'onderwijs alle volken'.
